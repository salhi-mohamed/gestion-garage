...
public class AjouterVoitureController {
    ...
    public void initialize() {
        // Aucune modification nécessaire ici pour le réceptionniste, mais il peut être initialisé à un autre endroit
    }

   public void ajouterVoiture() {
        // Récupérer le réceptionniste depuis le menu principal (MainMenuController)
