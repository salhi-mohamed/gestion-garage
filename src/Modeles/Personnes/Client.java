...
public class Client extends Personne {
    ...
    private String statutFinancier;     // Statut financier du client
    private ArrayList<Fourniture> fournitures_achetees;  // Liste des fournitures achetées
    ...
    // ----------------------- Méthodes de gestion des fournitures -----------------------
    ...
    // Supprimer une fourniture du client
    ...
    // Afficher les fournitures achetées par le client
